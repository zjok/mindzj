      ...
      >
        ...
        >
          ...
          <Show when={activeTab() === "appearance"}>
            ...
            <SettingSection title={t("toolbar.toggleTheme")}>
                  ...
                  {(opt) => (
                    <button
                      ...
                      style={{
                        flex: "1",
                        padding: "10px",
                        border: s().theme === opt.value
                          ? "2px solid var(--mz-accent)"
                          : "1px solid var(--mz-border)",
                        "border-radius": "var(--mz-radius-md)",
                        background: s().theme === opt.value
                          ? "var(--mz-accent-subtle)"
                          : "var(--mz-bg-primary)",
                        color: s().theme === opt.value
                          ? "var(--mz-accent)"
                          : "var(--mz-text-secondary)",
                        cursor: "pointer",
                        "font-size": "var(--mz-font-size-sm)",
                        "font-family": "var(--mz-font-sans)",
                        "font-weight": s().theme === opt.value ? "600" : "400",
